function S = F0AM_aqModelCore(Met,InitConc,ChemFiles,BkgdConc,ModelOptions,SolarParam)
...
%jmao: there is no need to convert ppb, aqueous solution conc is M (mol/L).
...
Chem.Rates = kbig.*G; %it is now M/s.
